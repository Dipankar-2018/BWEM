                      ...
                      <div class="form-row">                      
                          ...
                          <div class="col-lg-4 col-sm-4">
                            <div class="form-group has-default">
                              ...
                              <input type="text" class="form-control" id="InputAge" aria-describedby="age" placeholder="Enter Age" name="member_age[]" required>
                          ...
                          <div class="text-center">
                            <button type="button" class="btn btn-primary btn-round swalDefaultInfo" id="add_member">Add Member</button>                                                      
                          </div>
                        </div>
