  ...
  <div class="main main-raised" style="z-index: 1000;">
          ...
          <div class="col-md-6 ml-auto mr-auto">
            <div class="profile">
              <div class="avatar">
               ...
               <div class="name">
                <h2>Register Your Entrepreneur</h2>
              </div>
    ...
    <!-- Reg. Form Content Start-->
      <div class="section">
          ...
          <form method="post" action="./admin/backend/ep_insert.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-12">
                  <div class="card card-signup">
                  <h4 class="card-title text-center">Entrepreneur Details</h4>
                  <div class="card-body">
                      ...
                      <div class="form-row">
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Entrepreneur Registration Number" name="registration_no">
                          </div>
                        </div>
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            <label class="text-info"><b>ENTREPRENEUR NAME</b></label>
                            <input type="text" class="form-control" placeholder="Enter Entrepreneur Name" name="group_name">
                          </div>
                        </div>
