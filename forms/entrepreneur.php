                      ...
                      <div class="form-row">
                          ...
                          <div class="col-lg-12 col-sm-12">
                            <div class="form-group form-file-upload form-file-multiple">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control inputFileVisible" placeholder="Select File" required>
                                <span class="input-group-btn">
                                  <button type="button" class="btn btn-link btn-fab btn-primary">
                                    <i class="material-icons">attach_file</i>
                                  </button>
                          ...
                          <button id="submitMainForm" type="submit" name="submit" class="btn btn-primary">Submit</button>
                        </div>
