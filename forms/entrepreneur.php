            ...
            <div class="profile">
              <div class="avatar">
               ...
               <div class="name text-center">
                <h2>Register Your Startup / Business</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Entrepreneur  Details -->
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <h4 class="card-title text-center">Business Details</h4>
                  <div class="card-body">
                    <form>
                      <div class="form-row">
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            <label class="text-info"><b>REGISTRATION/LICENSE NUMBER</b></label>
                            <input type="text" class="form-control" placeholder="Enter Firm/Company Registration Number">
                          </div>
                        </div>
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            <label class="text-info"><b>BUSINESS/STARTUP/PLANT NAME</b></label>
                  ...
                  <div class="card-body">
                    <form>
                      <div class="form-row">
                          ...
                          <div class="col-lg-12 col-sm-12">
                            <div class="form-group form-file-upload form-file-multiple">
                              <label class="text-info"><b>UPLOAD BAN DOCUMENT (Passbook/Cancelled Cheque)</b></label>
                              <input type="file" multiple="" class="inputFileHidden">
                              <div class="input-group">
                                <input type="text" class="form-control inputFileVisible" placeholder="Select File">
                                <span class="input-group-btn">
