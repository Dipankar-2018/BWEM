  ...
  <div class="main main-raised" style="z-index: 1000;">
    ...
    <!-- Reg. Form Content Start-->
      <div class="section">
          ...
          <form method="post" action="./admin/backend/as_insert.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-12">
                  <div class="card card-signup">
                  <h4 class="card-title text-center">Association Details</h4>
                  <div class="card-body">
                      ...
                      <div class="form-row">
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Association Registration Number" name="registration_no">
                          </div>
                        </div>
                        <div class="col-lg-6 col-sm-4">
                          <div class="form-group has-default">
                            <label class="text-info"><b>ASSOCIATION NAME</b></label>
                            <input type="text" class="form-control" placeholder="Enter Association Name" name="group_name">
                          </div>
                        </div>
